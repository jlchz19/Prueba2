...
def home():
    try:
        ...
        import os
        template_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'templates', 'presentacion.html')
        if not os.path.exists(template_path):
            return f"Error: No se encuentra el archivo de plantilla en: {template_path}"
        
        # Si el archivo existe, intentar renderizarlo
        return render_template('presentacion.html')
    except Exception as e:
        return f"Error al cargar la plantilla: {str(e)}"
